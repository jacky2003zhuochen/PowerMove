...
method_list = ["break_chains+change_dest+move_split"]
# method_list = ['base', 'powermove']
rand_cost_para={0.1:0.3, 0.2:0.4, 0.3:0.6, 0.4:0.5, 0.5:0.3}
rand_cost_para2={0.1:5, 0.2:7, 0.3:0.3, 0.4:3, 0.5:5}
regular_cost_para={1:0.75, 2:0.5, 3:0.4, 4:0.25, 5:0.3, 6:0.2, 7:0.35, 8:0.3, 9:0.45, 10:0.65}
    ...
    # for P in [0.5]:
        ...
        # for thre in [0.75,0.85,0.95,0.65,1.2,1.5,2.5,3,4,7,15]:
            ...
            for n in N_Qubit_List:
                ...
                mvqc_transfer_duration, mvqc_move_duration, mvqc_cir_fidelity, mvqc_cir_fidelity_1q_gate, mvqc_cir_fidelity_2q_gate, mvqc_cir_fidelity_2q_gate_for_idle, mvqc_cir_fidelity_atom_transfer, mvqc_cir_fidelity_coherence, mvqc_nstage, count, loop_num, aod_num = mvqc([gates], Row, n, False, d, 1, method, cost_para, para1=thre, para2=cost_para2)
