...
cost_para_list = {'ising':30, 'wstate':4, 'qft':5}
...
for method in method_list:
    ...
    for benchm in bench_list:
        if benchm in cost_para_list.keys():
        ...
        # for para1 in [0.85,0.9,0.95]:
            ...
            # for thre in [5,7,10,15,20,30,50,80]:
            # for thre in [60,90]:
            ...
            loop_num_list = []
            for n in N_Bench_list[benchm][-3:]:
        # for n in [10, 20, 30, 50]:
            ...
            with open(f"data/compare_{benchm}_{method}_sim72_{para1}.txt", 'w') as file:
